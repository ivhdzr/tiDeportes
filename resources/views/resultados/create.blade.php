...
@section('title', 'Agregar resultado')
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ route('resultados.index') }}" class="btn btn-light"><i class="nav-icon fas fa-arrow-circle-left"></i>
                    Regresar</a>
                <form action="{{ route('resultados.store') }}" method="post" class="mt-2">
                    @csrf
                        ...
                        <select required name="partido_id" class="form-control">
                            ...
                            @foreach ($partidos as $partido)
                                <option value="{{ $partido->id }}"
                                    {{ old('equipo_id') == $partido->id ? 'selected' : '' }}>{{ $partido->nombre }}</option>
                            @endforeach
                        </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control" name="marcador_local" id="inputMarcadorLocal"
                                    placeholder="Ingresa el marcador local del partido" value="{{ old('marcador_local') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control" name="marcador_visitante" id="inputMarcadorVisitante"
                                    placeholder="Ingresa el marcador local del partido" value="{{ old('marcador_visitante') }}">
